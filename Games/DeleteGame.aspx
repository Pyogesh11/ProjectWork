...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnYes" runat="server" style="z-index: 1; left: 400px; top: 134px; position: absolute" Text="Yes" />
        ...
        <asp:TextBox ID="txtGame_Name" runat="server" style="z-index: 1; left: 436px; top: 75px; position: absolute"></asp:TextBox>
    </form>
</body>
</html>
